...
{
    const char* pszTimestamp = "https://twitter.com/KeroNFTs/status/1681752373184589824?s=20";
    const CScript genesisOutputScript = CScript() << ParseHex("9c8f13f8d45b8c857fbcbc8bc4a8e4d0f470216fe1b51850b4acf21b179c45070ac7b03a93eb4b1040184710fa689ad5023690c80f3a40f4d4604fa08dce601aaf") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 420420;
        ...
        genesis = CreateGenesisBlock(1691569420, 2002537298, 0x1e0ffff0, 1, 420 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc68222a0e864a512f1d194c2451d7010f517e1be6aadc852e7b985dd473e2b46"));
        assert(genesis.hashMerkleRoot == uint256S("0x6836586cd7b7aee60f5a1156034f06b9e30d18c8a36f05030a069e1a8aa13670"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("45.79.41.174", "45.79.41.174", true));
       //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("cococointools.com", "dnsseed.cococointools.com"));
        //vSeeds.push_back(CDNSSeedData("cococoinpool.org", "dnsseed.cococoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xc68222a0e864a512f1d194c2451d7010f517e1be6aadc852e7b985dd473e2b46"))
        ...
        chainTxData = ChainTxData{
            ...
            1691569420, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1691569420, 376351, 0x1e0ffff0, 1, 420 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5887c5a7657476c7be5194b94703a5bc064af567bbaaf4b924cb02e39bec30d2"));
        assert(genesis.hashMerkleRoot == uint256S("0x6836586cd7b7aee60f5a1156034f06b9e30d18c8a36f05030a069e1a8aa13670"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("45.79.41.174", "45.79.41.174"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.cococoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x5887c5a7657476c7be5194b94703a5bc064af567bbaaf4b924cb02e39bec30d2")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1691569420, 0, 0x207fffff, 1, 420 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1471762eef394d09f48ae255bcdfb3816d28f557b0fe45df9dae279fb7fa14fc"));
        assert(genesis.hashMerkleRoot == uint256S("0x6836586cd7b7aee60f5a1156034f06b9e30d18c8a36f05030a069e1a8aa13670"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x1471762eef394d09f48ae255bcdfb3816d28f557b0fe45df9dae279fb7fa14fc"))
        };
