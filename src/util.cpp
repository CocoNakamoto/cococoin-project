...
const char * const BITCOIN_CONF_FILENAME = "cococoin.conf";
const char * const BITCOIN_PID_FILENAME = "cococoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cococoin";
#else
    // Unix
