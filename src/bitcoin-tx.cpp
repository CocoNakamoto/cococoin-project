...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cococoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cococoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cococoin transaction") + "\n" +
              "  cococoin-tx [options] -create [commands]   " + _("Create hex-encoded cococoin transaction") + "\n" +
              "\n";
