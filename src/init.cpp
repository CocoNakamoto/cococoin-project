...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cococoin-project/cococoin>";
    const std::string URL_WEBSITE = "<https://cococoin.org>";
